...
public class SongsOfArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SongsOfArtistActivity.AsyncTaskRunner taskRunner = new SongsOfArtistActivity.AsyncTaskRunner();
        ...
        try {
            ...
            SongsOfArtistActivity.MyRecyclerViewAdapter myAdapter;
            recyclerView.setLayoutManager(new LinearLayoutManager(this));           // test if actually needed
            myAdapter = new SongsOfArtistActivity.MyRecyclerViewAdapter(this, artistsNames);
            myAdapter.setClickListener((MyRecyclerViewAdapter.ItemClickListener) SongsOfArtistActivity.this);
    ...
    public static class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder> {
        ...
        private SongsOfArtistActivity.MyRecyclerViewAdapter.ItemClickListener mClickListener;
        ...
        @Override
        public SongsOfArtistActivity.MyRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = null; //mInflater.inflate(R.layout.recyclerview_row, parent, false);
            return new SongsOfArtistActivity.MyRecyclerViewAdapter.ViewHolder(view);
        }
    ...
    private class AsyncTaskRunner extends AsyncTask<Object, Void, Map<ArtistName, ConnectionInfo>> {
        ...
        protected Map<ArtistName, ConnectionInfo> doInBackground(Object... objects) {
            Consumer c1 = new Consumer (ConnectionInfo.of("192.168.1.92",  430), SongsOfArtistActivity.this);
